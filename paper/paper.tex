...
\small{The CATDWAM experience. (Please change this.)}}
\author{
Alec Story,
Ansu Abraham,
Craig Frey,\\
...
\subsection{System Filters}
% This is where the MAGIC happens. I wanted to call them feature
% extractors like last time, but I'm not sure it that's correct.

\subsubsection{Question Rewrite}
% Alec
