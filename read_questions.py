...
#This will read in the questions with the answers and output a list of questions. Each question will be a list which has the id as the first entry, the question as the second entry, something that I didn't know what was happening but seemed relevant as the third entry, and the answer as the fourth entry.  Look in the file answers.txt and the format of my list will become clear
