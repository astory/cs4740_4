...
from pylab import randn, plot, scatter, hold, savefig
from monte.models.neuralnet import NNIsl
from monte import train

nn       = NNIsl(1,10,1)     #neural network with one hidden layer
#nntrainer  = train.Bolddriver(nn)
nntrainer  = train.Conjugategradients(nn,10)
...
for i in range(50):
    ...
    hold(True)
    plot(testinputs[0],nn.apply(testinputs)[0])
