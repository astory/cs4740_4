...
class LinearRegression(object):
    ...
    def __init__(self,numin, numout):
        ...
        self.numout = numout
        self.params = 0.01 * \
                      randn(backprop.neuralnet.Linearlayer.numparams(numin, numout))
...
class LinearLinear(object):
    ...
    def __init__(self,numin, numhid, numout):
        ...
        self.numhid = numhid
        self.numout = numout
        self.numparamslayer1 = backprop.neuralnet.Linearlayer.numparams(
                                                                numin, numhid)
        self.numparamslayer2 = backprop.neuralnet.Linearlayer.numparams(
                                                                numhid, numout)
        self.params = 0.01 * randn(self.numparamslayer1 + self.numparamslayer2)
        self.layer1 = backprop.neuralnet.Linearlayer(numin, numhid, 
                           self.params[:self.numparamslayer1])
        self.layer2 = backprop.neuralnet.Linearlayer(numhid, numout, \
                           self.params[self.numparamslayer1:])
        self.costmodule = backprop.cost.Squarederror()
...
class NNIsl(object):
    ...
    def __init__(self,numin, numhid, numout):
        ...
        self.numout = numout
        self.params = 0.01 * \
            randn(backprop.neuralnet.SigmoidLinear.numparams(numin, numhid, numout))
        self.bpmodule = backprop.neuralnet.SigmoidLinear(numin, numhid, numout, 
                                                   self.params)
...
class NNIslsl(object):
    ...
    def __init__(self,numin, numhid1, numhid2, numhid3, numout):
        ...
        self.numout = numout
        self.params = 0.01 * \
            randn(backprop.neuralnet.Islsl.numparams(numin, numhid1, 
                                                   numhid2, numhid3, numout))
        self.bpmodule = backprop.neuralnet.Islsl(numin, numhid1, numhid2, 
